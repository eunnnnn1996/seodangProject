...
<table>
   ...
   <c:forEach var="cart" items="${list}">
         <tr>
            ...
            <c:if test="${cart.class_kind eq 'off'}">
            	<td>오프라인 클래스</td>
	            <td>${cart.offclassVO.off_name} [ ${time} ]</td>
	            <td>${cart.order_quantity} </td>
   ...
   <tr>
   	<th colspan="6">
		<span style="font-size:20px">총합  <fmt:formatNumber value="${total }" pattern="#,###" /> 원</span>
	</th>
   </tr>
...
<form:form modelAttribute="orderVO" action="order.do" id="order_form" class="order_form2">
	...
	<ul>
		...
		<li>
			...
			<input type="button" onclick="sample2_execDaumPostcode()" value="우편번호 찾기" id="listbtn2">	
		...
		<div class="align-center">
			<input type="button" value="홈으로" class="listbtn-white2" onclick="location.href='${pageContext.request.contextPath}/main/main.do'">
			<input type="button" value="장바구니" class="listbtn-white2" onclick="location.href='${pageContext.request.contextPath }/cart/cartList.do'">
			<form:button class="listbtn-white2">주문</form:button>
		</div>
</form:form>
