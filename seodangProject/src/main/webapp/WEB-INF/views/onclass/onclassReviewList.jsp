...
<div class="review_list">
	...
	<c:if test="${count>0 }">
		...
		<div class="review-set"  data-num="${item.onstar_num}">
			<div class="review" >
				<div class="review_start">
					...
					<div class="re-btn">
					<button type="button" class="btn openPopup"  data-num="${item.onstar_num }"><img src="${pageContext.request.contextPath}/resources/images/menu-modify.png" width=22></button>
					</div>
					</c:if>
				</div>
			...
			<div class="reply-output" >
				...
				<div class="reply ${item.onstar_num }">
